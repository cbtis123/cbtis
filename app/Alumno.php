...
class Alumno extends Model
{
    ...
    */
    protected $fillable=['nombre','apellido_p','apellido_m','fecha_n','Curp','estado_c','clave_en','clave_mn','clave_mv','clave_lv','colonia','calle','cp','telefono_c','celular','semestre','turno'];
