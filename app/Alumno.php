...
class Alumno extends Model
{
    ...
    */
    protected $fillable=['nombre','apellido_p','apellido_m','fecha_n','curp','estado_c','clave_en','clave_mn','clave_mv','clave_lv','colonia','calle','cp','telefono_c','celular','especialidad_id','semestre','grupo_id','status'];
